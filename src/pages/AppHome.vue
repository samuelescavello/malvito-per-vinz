    ...
    <main>
        ...
        <div class="container">
            ...
            <div class="row my-5 text-center">
                ...
                <p>La struttura vanta grandi spazi aperti che offrono un'oasi di tranquillità e relax. Il giardino,
                    curato nei minimi dettagli, è arricchito da una varietà di piante e fiori che creano un'atmosfera
                    incantevole e profumata.</p>
                        ...
                        <div class="col-md-6 order-md-1 my-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled">
                                        <li><i class="fa-solid fa-location-dot"></i> C/da Trellenze, snc - 87010 Malvito
                                            (Cs)
                                        </li>
                                    </ul>
                                    <div class="mt-3">
